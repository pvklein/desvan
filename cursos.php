...
<header id="cabecera" >
             <div class="row row-header">
				...
				<div class="col-xs-12 col-sm-6" id="titulo">
                    	<p id="cont-68p" style="padding-top:80px" class="hidden-xs hidden-md hidden-sm">El Desván de Carol</p>
						<p id="cont-40p" style="padding-top:80px" class="hidden-lg">El Desván de Carol</p>						
				</div>
				<div class="col-xs-12 col-sm-4 hidden-xs" id="titulo" style="padding-top:100px">
                    	<div id="direccion">C/Ramón y Cajal nº8</div>
...
<div class="container">
	<div class="row">
		...
		<h2> Talleres diarios</h2>
		<ul class="nav nav-tabs">
  <li class="active"><a data-toggle="tab" href="#home">Patchwork</a></li>
  <li><a data-toggle="tab" href="#menu1">Manualidades</a></li>
  <li><a data-toggle="tab" href="#menu2">Punto y Ganchillo</a></li>
  <li><a data-toggle="tab" href="#menu3">Patronaje</a></li>
</ul>
...
<div class="tab-content">
  <div id="home" class="tab-pane fade in active">
    <div class="media">
        <div class="media-left media-middle">
        	<img class="media-object img-thumbnail" src="img/uthappizza.png" alt="Uthappizza" width="300">
        </div>
        <div class="media-body">
        	<h2 class="media-heading">Patchwork</h2>
            	<p>Clases de patchwork haciendo las polladas esas de colchas y demás,vamos lo que viene siendo chachear con el resto de alumnas y realmente no hacer ni el guevo</p>
				<p>Horario:</br>
				   L,M,X: 9h - 11h</br>
				   J,V: 17h - 19h</p>
                <p><a class="btn btn-primary btn-xs" href="#">Más información</a></p>
        </div>
    </div>
  </div>
  <div id="menu1" class="tab-pane fade">
    <div class="media">
        ...
        <div class="media-body">
        	<h2 class="media-heading">Manualidades</h2>
            	<p>Clases de patchwork haciendo las polladas esas de colchas y demás,vamos lo que viene siendo chachear con el resto de alumnas y realmente no hacer ni el guevo</p>
				<p>Horario:</br>
				   L,M,X: 9h - 11h</br>
				   J,V: 17h - 19h</p>
  ...
  <div id="menu2" class="tab-pane fade">
    <div class="media">
        ...
        <div class="media-body">
        	<h2 class="media-heading">Punto y ganchillo</h2>
            	<p>Clases de patchwork haciendo las polladas esas de colchas y demás,vamos lo que viene siendo chachear con el resto de alumnas y realmente no hacer ni el guevo</p>
				<p>Horario:</br>
				   L,M,X: 9h - 11h</br>
				   J,V: 17h - 19h</p>
  ...
  <div id="menu3" class="tab-pane fade">
    <div class="media">
        ...
        <div class="media-body">
        	<h2 class="media-heading">Patronaje</h2>
            	<p>Clases de patchwork haciendo las polladas esas de colchas y demás,vamos lo que viene siendo chachear con el resto de alumnas y realmente no hacer ni el guevo</p>
				<p>Horario:</br>
				   L,M,X: 9h - 11h</br>
				   J,V: 17h - 19h</p>
        ...
        <div class="container">
            <div class="row row-footer">             
                ...
                <div class="col-xs-12">
                    ...
                    <p align=center>© Copyright 2017 El Desván de Carol</p>
                </div>
            </div>
        </div>
	</div>	
